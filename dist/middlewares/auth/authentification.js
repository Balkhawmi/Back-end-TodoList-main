...
exports.authorization = exports.authentificated = void 0;
...
const authentificated = () => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!JSECRET_ACCESS_TOKEN) {
            return res.status(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR).send(response_1.default.response(null, http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR.valueOf(), 'Secret key not provided'));
        }
